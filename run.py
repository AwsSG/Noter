...
def register():
    if request.method == "POST":
        ...
        existing_user = mongo.db.userdb.find_one(
...
def edit_task(task_id):
    if request.method == "POST":
        ...
        mongo.db.tasks.update({"_id": ObjectId(task_id)}, updated)
...
def delete_task(task_id):
    ...
    flash("Well done on completing this task! this task is now deleted")
    return redirect(url_for("get_tasks"))
...
def edit_category(category_id):
    if request.method == "POST":
        ...
        flash("Category was updated successfully!")
        return redirect(url_for("get_categories"))
...
def delete_category(category_id):
    ...
    flash("Category was deleted successfully!")
    return redirect(url_for("get_categories"))
